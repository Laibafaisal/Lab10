...
{
    protected enum GradeLevel { FirstYear, SecondYear, ThirdYear, FourthYear};
    protected class Student
    {
        ...
        protected static List<Student> students = new List<Student>
        {
            ...
            new Student(){FirstName = "Hnaiyang", LastName= "Feng", ID =117, Year = GradeLevel.FirstYear, ExamScores=new List<int>{93,92,80,87 } },
...
public class Program
{
    public static void Main()
    {
        ...
        Console.WriteLine("Press any keyto exit"); 
        Console.ReadKey();
    }
}
